...
#define OBJ_CONTROLWORD				0x6040		// RW,	UNIT16
#define OBJ_OPERATIONMODE			0x6060		// RW,	UNIT8
#define OBJ_OPERATIONMODE_MONITOR	0x6061		// R,	UINT8
#define OBJ_POSITION_ACTUAL 		0x6063		// R,	INT32
